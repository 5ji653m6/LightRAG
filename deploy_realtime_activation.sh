#!/bin/bash
# Deploy real-time query activation feature
...
echo "🚀 Deploying real-time query activation feature..."
...
echo "  - Copying query_routes.py (with activation tracking)..."
...
echo ""
echo "📝 New features:"
echo "1. All /query/data calls are now tracked"
echo "2. 3D viewer polls for new activations every 2 seconds"
echo "3. Queries from anywhere trigger real-time neuron activation"
echo ""
echo "🧪 Test it:"
echo "1. Open http://localhost:9621/graph3d/viewer in browser"
echo "2. In another terminal, run: curl -X POST http://localhost:9621/query/data \\"
echo "     -H 'Content-Type: application/json' \\"
echo "     -d '{\"query\": \"testosterone\", \"mode\": \"hybrid\", \"top_k\": 20}'"
echo "3. Watch the neurons activate in real-time!"
echo ""
